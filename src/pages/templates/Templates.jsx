...
export default function Templates() {
  ...
  async function save() {
    if (!form.name || !form.whatsappTemplateName) {
      toast.error('Name and WhatsApp template name required')
      return
    }
    setSaving(true)
    try {
  ...
  return (
    <div className="space-y-6">
                  ...
                  <TR key={t._id}>
                    ...
                    <TD>
                      <div className="flex gap-2">
                        <Button type="button" size="sm" variant="ghost" onClick={() => setPreviewId(previewId === t._id ? null : t._id)}>
                          Preview
                        </Button>
                        <Button type="button" size="sm" variant="danger" onClick={() => remove(t._id)}>
                          Delete
                        </Button>
                      </div>
                    </TD>
      ...
      <Modal
        ...
        footer={
          <ModalActions loading={saving} onCancel={() => setOpen(false)} onConfirm={save} />
        }
      >
        <div className="space-y-3">
          ...
          <label className="block w-full">
            ...
            <textarea
              className="w-full min-h-[100px] rounded-lg border border-[#334155] bg-[#0F172A] px-3 py-2 text-[#F1F5F9]"
